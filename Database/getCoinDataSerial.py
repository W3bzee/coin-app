...
def getCoinDataSerial(serial):
    ...
    dataToAppend = {'PCGS #':Pcgs_no,'Description':row['Denomination'].iloc[0], 'Grade':Grade,'Service':service,'CAC':'','Cost':'','Price':'','Certification ID':Certification_ID_num,'Addl. Description':row['coin_no'].iloc[0]}
